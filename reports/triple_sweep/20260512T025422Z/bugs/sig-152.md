...
- input: `[16, 11, "\u0000 /ࠀ/", 5e-324, "𐀀", -9223372036854775808, -40]`

Canonical per implementation:
- **python** (len 63, sha 2ae3ca5d7bada2b6...):

  ```
  [16,11,"\u0000 /ࠀ/",5e-324,"𐀀",-9223372036854775808,-40]
  ```
- **go** (len 66, sha fd6533e60d87908e...):

  ```
  [16,11,"\u0000\u2028/ࠀ/",5e-324,"𐀀",-9223372036854775808,-40]
  ```
- **rust** (len 63, sha 2ae3ca5d7bada2b6...):
